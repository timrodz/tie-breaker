defmodule MtgFriendsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MtgFriendsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MtgFriendsWeb.Gettext, "errors", msg, opts)
    end
  end
